...
$self_url = CORE_PRIVACY_TOGGLE_ADMIN.'-photo&amp;image_id='.$_GET['image_id'];
...
$tabsheet->select('core_privacy_toggle');
$tabsheet->assign();
...
$template->set_filename('core_privacy_toggle_content', realpath(CORE_PRIVACY_TOGGLE_PATH . 'admin/template/photo.tpl'));
