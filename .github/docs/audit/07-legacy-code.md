...
| --------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- | -------------------------------------- |
| [tools/https\_\_\_piwigo.local_albums_profile.html](../../../tools/https___piwigo.local_albums_profile.html)                | Saved crawl of a live local gallery page in the working tree (untracked — `tools/` is gitignored) | Delete locally; keep gitignored        |
| `tests/` + `phpunit.xml.dist` gitignored                                                                                    | The repository ships **without its test suite**; CI PHPUnit job has nothing to run (M3)           | Track them in git                      |
| `language/*` locales                                                                                                        | All 8 locales ship `plugin.lang.php` ✔ — but they replicate ~70 unused owner-profile keys (L3/M7) | Prune keys across all locales together |
